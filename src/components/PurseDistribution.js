    ...
    render() {
        return (
            <div id="content" className="mt-3" >
                ...
                &nbsp;
                <h2 className="table table-borderless text-muted text-center">Distribution of $Purse to $PUNDI X holders</h2>
                <h6 className="table table-borderless text-muted text-center">Distribution End-Date : {this.props.endDistributeDate.toString()}</h6>
